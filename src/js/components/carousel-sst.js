export default{name:"CarouselSst",data(){return{carousel:{class:"carousel-sst",key:0,elemento:null,qtdSlides:0,ordem:1,ordemAnterior:99},instances:null,items:[{id:1,img:"src/img/carousel01.png",alt:"Carga",html:`
            <p>
            ...
            `},{id:2,img:"src/img/carousel02.png",alt:"Carga",html:`
            <p>
            A carga deve ter espaços adequados para o encaixe dos dedos e permitir uma boa preensão.​
            </p>
            `},{id:3,img:"src/img/carousel03.png",alt:"Carga",html:`
            <p>
            ...
            `},{id:4,img:"src/img/carousel04.png",alt:"Carga",html:`
            <p>
            ...
            `},{id:5,img:"src/img/carousel05.png",alt:"Carga",html:`
            <p>
...
​
            `},{id:6,img:"src/img/carousel06.png",alt:"Carga",html:`
            <p>
